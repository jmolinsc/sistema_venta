...
@section('content_header')
    <h1><b>Compras/Nueva Compra</b></h1>
    <hr>
@stop
@php
    $total_cantidad = 0;
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/compras/store') }}" id="formCompra" method="POST"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($tmp_compras as $tmp_compra)
                                                    @php
                                                        ...
                                                        $precio_total +=
                                                            $tmp_compra->cantidad *
                                                            $tmp_compra->producto->precio_compra;
                                                    @endphp
                                                    <tr>
                                                        <th scope="row"
                                                            style="text-align:center;vertical-align: middle;">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="fecha" id="fecha" class="form-control"
                                                value="{{ old('fecha') }}" placeholder="Ingrese la fecha">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="comprobante" id="comprobante"
                                                class="form-control" value="{{ old('comprobante') }}"

...
@section('content_header')
    <h1><b>Clientes/Listado de Clientes</b></h1>
    <hr>
@stop
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.clientes.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                            Crear
                            Cliente</a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table id="tbClientes" class="table table-striped table-bordered table-hover table-sm">
                                    ...
                                    <td style="text-align: center">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <form action="{{ url('/admin/clientes/' . $cliente->id) }}" method="POST"
                                                style="display:inline;" onclick="preguntar{{ $cliente->id }}(event)"
                                                ...
                                                function preguntar{{ $cliente->id }}(event) {
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        if (result.isConfirmed) {
                                                            var formulario = document.getElementById("miFormulario{{ $cliente->id }}");

                        ...
                        <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="codigo" id="codigo" class="form-control"
                                                value="{{ $producto->codigo }}" placeholder="Ingrese el codigo del producto"
                                                required>
                                            @error('codigo')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="stock" id="stock" class="form-control"
                                                value="{{ $producto->stock }}" placeholder="Ingrese el stock del producto"
                                                required>
                                            @error('stock')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" step="0.01" name="precio_compra" id="precio_compra"
                                                class="form-control" value="{{ $producto->precio_compra }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="fecha_ingreso" id="fecha_ingreso"
                                                class="form-control" value="{{ $producto->fecha_ingreso }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="descripcion" id="descripcion" class="form-control" rows="2"
                                                placeholder="Ingrese una descripcion del producto">{{ $producto->descripcion }}</textarea>
                                            @error('descripcion')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <br>
                                    <output id="list"><img src="{{ asset('storage/' . $producto->imagen) }}" alt="Imagen del producto" style="max-width: 100px; max-height: 100px;"></output>
                                    <script>
